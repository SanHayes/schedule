	...
	<view class="content">
		<view class="form-box">
			<view class="form-item u-flex u-row-between">
				...
				<input class="input" v-model="oldPsd" type="text" :placeholder="$t('common.plc')" placeholder-style="color:#C0C4CC;fontSize:15px" />
			</view>
			<u-line color="#D6D7D9" />
			<view class="form-item u-flex u-row-between">
				<view class="label font-main px-font-15">
				...
				<input class="input" v-model="newPsd" type="text" :placeholder="$t('common.plc')" placeholder-style="color:#C0C4CC;fontSize:15px" />
			</view>
			<u-line color="#D6D7D9" />
			<view class="form-item u-flex u-row-between">
				<view class="label font-main px-font-15">
				...
				<input class="input" v-model="confirmPsd" type="text" :placeholder="$t('common.plc')" placeholder-style="color:#C0C4CC;fontSize:15px" />
			</view>
		</view>
